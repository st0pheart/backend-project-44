...
[![hexlet-check](https://github.com/st0pheart/backend-project-44/actions/workflows/hexlet-check.yml/badge.svg)](https://github.com/st0pheart/backend-project-44/actions)
...
Учебный проект Хекслета: https://ru.hexlet.io/programs/backend
...
```bash
git clone https://github.com/st0pheart/backend-project-44.git
